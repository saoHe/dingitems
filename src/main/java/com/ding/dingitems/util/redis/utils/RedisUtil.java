package com.ding.dingitems.util.redis.utils;
...
public class RedisUtil {
    ...
    public static void main(String[] args) {
		...
		JedisPool jedisPool = new JedisPool(jedisPoolConfig,"10.8.51.104",6379,100,"123456");
		Jedis jedis = jedisPool.getResource();
        jedis.select(0);
        for (int i = 0; i < 10; i++) {
            long value  = jedis.incr(("user123keycount").getBytes());
            System.out.println(value);
        }
        jedis.expire(("user123keycount").getBytes(),10);
